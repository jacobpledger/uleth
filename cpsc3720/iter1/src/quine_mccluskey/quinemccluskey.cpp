...
string Get_SOP_Expression_String(TruthTableString_t truth_table_string, vector<string> var_names)
{
    string sop_string;

    Implicants_t solution = Quine_McCluskey(truth_table_string);
...
string Get_POS_Expression_String(TruthTableString_t truth_table_string, vector<string> var_names)
{
    string pos_string;
